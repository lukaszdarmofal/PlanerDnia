...
public partial class MainWindow : Window
{
    ...
    private void CreateTask(object sender, RoutedEventArgs e)
    {
        ...
        if (Panel_TaskGrid.Children.Count < 8)
        {
            ...
            var taskName = new TextBlock { Text = newTask.Name, HorizontalAlignment = HorizontalAlignment.Center };
            var taskCategory = new ComboBox { HorizontalAlignment = HorizontalAlignment.Center };
            ...
            var taskFinished = new CheckBox { IsChecked = newTask.IsFinished, Content = "Zakończono", HorizontalAlignment = HorizontalAlignment.Center };
            var taskDelete = new Button { Content = "Usuń", HorizontalAlignment = HorizontalAlignment.Center};
            taskDelete.Click += DeleteTask;
            
            var taskElement = new StackPanel { Width = 180, Height = 130 };
            ...
            var taskBorder = new Border { Width = 190 , Height = 150, BorderBrush = Brushes.Salmon , Background = Brushes.Salmon };
